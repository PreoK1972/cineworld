...
export default function CategoryFilter() {
  ...
  return (
    <div className="relative z-20 -mt-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="glass-panel rounded-2xl p-2.5 sm:p-3.5 shadow-2xl flex items-center gap-2 overflow-x-auto no-scrollbar">
        {GENRE_LIST.map((genre) => {
          ...
          return (
            <button
              ...
              className={`whitespace-nowrap px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 flex items-center gap-1.5 shrink-0 ${
                isActive
